...
public class Practice14GetFontMetricsView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float center = middle + yOffset;

        canvas.drawText(texts[0], 100, center, paint2);
        canvas.drawText(texts[1], 200, center, paint2);
        canvas.drawText(texts[2], 300, center, paint2);
        canvas.drawText(texts[3], 400, center, paint2);
        canvas.drawText(texts[4], 500, center, paint2);
        canvas.drawText(texts[5], 600, center, paint2);
    }
